...
const storeValue = {};
const inputFill = (0, _lodashThrottleDefault.default)(()=>{
...
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (storedValue) try {
        ...
        if (parsedValue.email == undefined) emailForm.value = "";
        else emailForm.value = parsedValue.email;
        if (parsedValue.message == undefined) messageForm.value = "";
        else messageForm.value = parsedValue.message;
    } catch (error) {
...
},{}]},["ggsen","eH52W"], "eH52W", "parcelRequired7c6")
